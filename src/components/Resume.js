                ...
                <div className="text-dark">
                    <div className="content mb-5 mt-3">
                        ...
                        <div className='position'>
                            ...
                            <span className='time-period'>September 2018 - February 2019</span>
                        </div>
                        <div className='position'>
                        ...
                        <div className='project'>
                            ...
                            <span className='supplemental'><b>Technologies:</b> Embedded C, Microcontroller, Microsoft Visual C#</span>
